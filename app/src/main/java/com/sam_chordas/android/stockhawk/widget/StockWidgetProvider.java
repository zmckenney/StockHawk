...
public class StockWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            //Todo change first to GraphActivity...changged to MyStocksActivity for testing
            //Works when sending to MyStocksActivity because it doesnt need to know the position of the item
            //When sending to GraphActivity it needs to know which item is being selected
